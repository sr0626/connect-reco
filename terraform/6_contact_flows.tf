resource "aws_connect_contact_flow" "test" {
  ...
  type         = "CONTACT_FLOW"
  content      = file("${path.module}/../json/contact_flows/MyBusinessMainFlow.json")
  content_hash = filebase64sha256("${path.module}/../json/contact_flows/MyBusinessMainFlow.json")
}
